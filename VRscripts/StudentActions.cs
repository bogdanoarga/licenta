...
public class StudentActions : MonoBehaviour
{
    ...
    public bool PlayVoiceLine()
    {
        ...
        if (meltdownTriggered)
        {
            ...
            // disable nonverbal movement during meltdown
            var nonVerbal = GetComponent<NonVerbalResponse>();
            if (nonVerbal != null)
                nonVerbal.enabled = false;
            return false;
        }
    ...
    public void EndMeltdown()
    {
        ...
        // re-enable nonverbal after meltdown
        var nonVerbalReset = GetComponent<NonVerbalResponse>();
        if (nonVerbalReset != null)
            nonVerbalReset.enabled = true;
    }
}
